...
from dataset import (
    _load_mono, _random_segment, _scale_to_snr, _list_speech_files,
...
def main(args):
    ...
    for i in range(args.n_examples):
        # mirror DynamicMixDataset.__getitem__ but keep each intermediate signal exposed
        ...
        babble = _scale_to_snr(target, babble, snr_db)
